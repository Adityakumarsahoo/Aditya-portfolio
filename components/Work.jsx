...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      Welcome to my full stack development portfolio! Explore a collection of projects showcasing my expertise in front-end with back-end development.</motion.p>
